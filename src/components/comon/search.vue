  ...
  <!--<el-col :span="24" class="filter-box">-->
    ...
    <!--<div class="filter-right">-->
      <!--<template v-for="(item, index) in items">-->
        ...
        <!--</el-date-picker>-->
        <!--<my-date v-if="item.type=== 'monthrange'" class="monthrange" :value="monthValue"></my-date>-->
      <!--</template>-->
      <!--<template>-->
...
<!--export default {-->
  ...
  <!--data () {-->
    <!--return {-->
      ...
      <!--pageSize: 10,-->
      <!--monthValue: { startMonth: null, endMonth: null },-->
      <!--pickerOptions: {-->
        <!--shortcuts: [{-->
          <!--text: '今天',-->
          <!--onClick (picker) {-->
      ...
      <!--if (this.items) {-->
        ...
        <!--Object.keys(this.items).forEach(key => {-->
          <!--if (this.items[key].type === 'monthrange') {-->
            <!--params[this.items[key].start] = this.monthValue.startMonth-->
            <!--params[this.items[key].end] = this.monthValue.endMonth-->
          <!--}-->
